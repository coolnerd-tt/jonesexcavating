"""
Jones Excavating Co. × Callus Fabrication — Proposal v4
v4 adds the Marketing OS chapter: an AI-agent-driven marketing automation
system the client owns and operates after launch. Pricing reframes into a
three-tier ongoing model (Concierge / Co-pilot / Self-serve).
"""
...
class Canv:
    def on_page(self, c, doc):
        ...
        if page == 1:
            ...
            c.drawRightString(W-30, H-26, 'CONFIDENTIAL  |  PROPOSAL v4  |  APRIL 2026')
        else:
            # Top header bar
...
def build():
    doc = SimpleDocTemplate(
        ...
        title='Jones \u00D7 Callus \u2014 Proposal v4',
    )
    s = []
    cb = Canv()
